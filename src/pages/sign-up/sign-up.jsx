  ...
  return (
     <div className="sign-up">
      ...
      <div className="info">
        ...
        <br />
        <button className='sign-up-google'><FcGoogle  className='google-icon'/> Sign up with Google</button>
        <p className='owned'>Already have account? <Link to={"/log-in"} className='link'>log-in</Link></p>
